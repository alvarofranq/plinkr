...
first. Then you can install the latest stable version from CRAN using the following 
command:
...
You can install the latest development version, you can install it from GitHub.
